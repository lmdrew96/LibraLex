...
// The History view of the Shelf page (/?view=history). Was its own /history tab
// until v0.50 folded it into Shelf to fit the nav on phones.
export function HistoryView() {
  ...
  return (
    <>
      <p className="mb-5 text-teal">Everything you&apos;re reading and have read — across every shelf.</p>
